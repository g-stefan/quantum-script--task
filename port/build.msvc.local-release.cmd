...
echo -^> local-release quantum-script-extension-task
...
call :cmdX xyo-cc quantum-script-extension-task --archive-release-sha512 --version-file=source/quantum-script-extension-task.version.ini
