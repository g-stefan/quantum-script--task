...
call :cmdX xyo-cc --mode=%ACTION% @util/quantum-script-extension-task.static.compile
call :cmdX xyo-cc --mode=%ACTION% @util/quantum-script-extension-task.dynamic.compile
