...
call :cmdX xyo-cc --mode=%ACTION% @build/source/quantum-script-extension-task.static.compile
call :cmdX xyo-cc --mode=%ACTION% @build/source/quantum-script-extension-task.dynamic.compile
